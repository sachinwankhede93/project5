...
public class ArrayListExample6 {
	public static void main(String[] args) {
		...
		Collections.sort(l2);
		System.out.println("After sorting Elements of collection: "+l2);// ascending order
		Collections.reverse(l2);
		System.out.println("Reversing sorted Elements of collection: "+l2);//descending order
